<form id="gymForm" class="form-horizontal hidden"  method="POST" action="" onsubmit="return checkInputs();">
	<fieldset>
		<div class="form-group">
			...
			<div class="row row-centered row-padding">
				<div class="col-sm-6 col-centered">
					<label for="newGymName" class="required-label">Gym name</label>
                         <input type="text" class="form-control required" id="newGymName" name="newGymName" placeholder="Gym name">
                    </div>
               </div>
			...
			<div class="row row-centered row-padding">
				<div class="col-sm-6 col-centered">
					<label for="newContactFirstName" class="required-label">Contact first name</label>
                         <input type="text" class="form-control required" id="newContactFirstName" name="newContactFirstName" placeholder="Contact first name">
                    </div>
               </div>
               
               <div class="row row-centered row-padding">
				<div class="col-sm-6 col-centered">
					<label for="newContactLastName" class="required-label">Contact last name</label>
					<input type="text" class="form-control required" id="newContactLastName" name="newContactLastName" placeholder="Contact last name">
				</div>
			</div>
