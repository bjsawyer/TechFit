...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 17, 2015 at 10:22 PM
...
(10, 'War Memorial', 'War', 'Rep', '50.0000', 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday', '8AM-10PM', 'Pool,Basketball Court,Sauna', 1, 'Gold', NULL, 'Located right off the Drillfield, War Memorial is a more traditional gym provided by Virginia Tech.  A bit smaller and usually less crowded, this is a great alternative to McComas with many of the same amenities.'),
(11, 'The Weight Club', 'Weight Club', 'Rep', '42.0000', 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday', '8AM-10PM', 'Track', 1, 'Platinum', NULL, 'Located at the University Mall, the Weight Club offers all the necessary equipment for the body you''re looking for.  Great for those looking for a gym outside of campus.'),
...
(13, 'Crossfit Blacksburg', 'Crossfit', 'Rep', '45.0000', 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday', '8AM-10PM', '', 1, 'Gold', NULL, 'Just past Downtown Blacksburg, Crossfit Blacksurg incorporates all the activities and equipment for trending crossfit excercises.');
...
CREATE TABLE IF NOT EXISTS `trainer` (
  ...
  `MembershipLevel` varchar(255) DEFAULT NULL,
  `ClassesOffered` tinyint(1) DEFAULT '0',
  `Specialties` set('Balance','Core','Endurance','Flexibility','Rehabilitation','Strength','Water Aerobics','Weight Loss') DEFAULT NULL,
...
(6, 'Billy', 'Ozycz', 'Male', '20.0000', 'Silver', 0, 'Balance,Core,Endurance,Flexibility,Weight Loss', 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday', '8AM-10PM', NULL, 'Everyday two-a-days is a normal thing for me and can be for you too!  With the right balance of lifting and cardio I can give you the nice, toned body you have always wanted.'),
(3, 'JP', 'Theo', 'Male', '25.0000', 'Gold', 1, 'Core,Endurance,Flexibility,Strength,Water Aerobics', 'Monday,Tuesday,Wednesday,Thursday,Friday', '8AM-10PM', NULL, 'Avid athlete in all sports - currently Rugby at Virginia Tech.  With monster biceps and indestructable core there is no surprise to why the people call him "Big Sexi."'),
(4, 'Shawn', 'Neylon', 'Male', '30.0000', 'Platinum', 1, 'Balance,Core,Endurance,Rehabilitation,Strength', 'Sunday,Friday,Saturday', '8AM-10PM', NULL, 'Former Marine and US Marshal, workouts with me will push you to the limit.  I am a working man with a family so for those of you looking to book sessions on the weekend - I''m your guy.');
