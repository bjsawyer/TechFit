...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 16, 2015 at 02:08 AM
...
CREATE TABLE IF NOT EXISTS `ae_trainingregistration` (
  ...
  `TrainingDateTime` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gym` (
  ...
  `DaysOperation` set('Sunday','Monday','Tuesday','Wednesday','Thurday','Friday','Saturday') DEFAULT NULL,
...
INSERT INTO `gym` (`ProviderId`, `Name`, `ContactFirstName`, `ContactLastName`, `Rate`, `DaysOperation`, `HoursOperation`, `Amenities`, `ClassesOffered`, `MembershipLevel`, `ProfilePictureUrl`, `ProfileDescription`) VALUES
(9, 'McComas', 'Mccomas', 'Rep', '50.0000', '', '8AM-10PM', 'Pool,Basketball Court,Sauna,Track', 1, 'Silver', NULL, 'Located right off Washington Street, McComas is a state of the art gym provided by Virginia Tech.  The facility offers a wide range of amenities and workout equipment.'),
(10, 'War Memorial', 'War', 'Rep', '50.0000', '', '8AM-10PM', '', 1, 'Gold', NULL, 'Located right off the Drillfield, War Memorial is a more traditional gym provided by Virginia Tech.  A bit smaller and usually less crowded, this is a great alternative to McComas with many of the same amenities.'),
(11, 'The Weight Club', 'Weight Club', 'Rep', '42.0000', '', '8AM-10PM', '', 1, 'Platinum', NULL, 'Located at the University Mall, the Weight Club offers all the necessary equipment for the body you''re looking for.  Great for those looking for a gym outside of campus.'),
(12, 'Anytime Fitness', 'Anytime Fitness', 'Rep', '40.0000', '', '8AM-10PM', 'Tanning', 1, 'Silver', NULL, 'Near the plazas off South Main, Anytime Fitness is perfect for those struggling to find time to workout.  Open 24/7 with tons of amenities, there will be no issues fitting exercise into your schedule.'),
(13, 'Crossfit Blacksburg', 'Crossfit', 'Rep', '45.0000', '', '8AM-10PM', '', 1, 'Gold', NULL, 'Just past Downtown Blacksburg, Crossfit Blacksurg incorporates all the activities and equipment for trending crossfit excercises.');
...
(4, 'smneyl@gmail.com', 'diesel', '5403495939', '4567 Progress St', 'Blacksburg', 'VA', 24060, 'Trainer'),
...
(9, 'mccomasgym@vt.edu', 'mccomas', '5402316856', '895 Washington St', 'Blacksburg', 'VA', 24060, 'Gym'),
...
INSERT INTO `trainer` (`ProviderId`, `FirstName`, `LastName`, `Gender`, `Rate`, `MembershipLevel`, `ClassesOffered`, `Specialties`, `DaysAvailability`, `HoursAvailability`, `ProfilePictureUrl`, `ProfileDescription`) VALUES
(6, 'Billy', 'Ozycz', 'Male', '20.0000', 'Silver', 0, '', '', '8AM-10PM', NULL, 'Everyday two-a-days is a normal thing for me and can be for you too!  With the right balance of lifting and cardio I can give you the nice, toned body you have always wanted.'),
(3, 'JP', 'Theo', 'Male', '25.0000', 'Gold', 1, '', '', '8AM-10PM', NULL, 'Avid athlete in all sports - currently Rugby at Virginia Tech.  With monster biceps and indestructable core there is no surprise to why the people call him "Big Sexi."'),
(4, 'Shawn', 'Neylon', 'Male', '30.0000', 'Platinum', 1, '', '', '8AM-10PM', NULL, 'Former Marine and US Marshal, workouts with me will push you to the limit.  I am a working man with a family so for those of you looking to book sessions on the weekend - I''m your guy.');
...
(3, 'Brendan', 'Sawyer', 'bjsawyer@vt.edu', 'sawyerbeatz', 'Male', '321 Center Street', 'Blacksburg', 'VA', 24060, '703-655-3286', 'Gym'),
