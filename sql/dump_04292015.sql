...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 29, 2015 at 09:01 PM
...
(118, 'The Edge', 'Edge', 'Rep'),
(117, 'The Village At Blacksburg', 'Village', 'Rep');
...
INSERT INTO `ae_adpurchase` (`PurchaseDate`, `AdUrl`, `LocationId`, `ProviderId`) VALUES
('2015-03-26', NULL, 3, 117),
('2015-04-02', NULL, 4, 118);
...
(1, 9, 'McComas', 'Mccomas', 'Rep', '50.00', 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday', '8AM-10PM', 'Pool,Basketball Court,Sauna,Track', 1, 'Silver', 'M_mccomas.jpg', 'Located right off Washington Street, McComas is a state of the art gym provided by Virginia Tech.  The facility offers a wide range of amenities and workout equipment.'),
(2, 10, 'War Memorial', 'War', 'Rep', '50.00', 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday', '8AM-10PM', 'Pool,Basketball Court,Sauna', 1, 'Gold', 'war-memorial-hall-virginia-tech.jpg', 'Located right off the Drillfield, War Memorial is a more traditional gym provided by Virginia Tech.  A bit smaller and usually less crowded, this is a great alternative to McComas with many of the same amenities.'),
(3, 11, 'The Weight Club', 'Weight Club', 'Rep', '42.00', 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday', '8AM-10PM', 'Track', 1, 'Platinum', 'weightclub.jpg', 'Located at the University Mall, the Weight Club offers all the necessary equipment for the body you''re looking for.  Great for those looking for a gym outside of campus.'),
(4, 12, 'Anytime Fitness', 'Anytime Fitness', 'Rep', '40.00', 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday', '8AM-10PM', 'Tanning', 1, 'Silver', 'war-memorial-hall-virginia-tech.jpg', 'Near the plazas off South Main, Anytime Fitness is perfect for those struggling to find time to workout.  Open 24/7 with tons of amenities, there will be no issues fitting exercise into your schedule.'),
(5, 13, 'Crossfit Blacksburg', 'Crossfit', 'Rep', '45.00', 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday', '8AM-10PM', '', 1, 'Gold', NULL, 'Just past Downtown Blacksburg, Crossfit Blacksurg incorporates all the activities and equipment for trending crossfit excercises.');
...
(118, 'theedgefakeemail@gmail.com', 'theedge', '5405523343', '321 Edge Way', 'Blacksburg', 'VA', 24060, 'Advertiser'),
(117, 'live@thevillage-blacksburg.com', 'thevillage', '5409531800', '1600 Patrick Henry Drive', 'Blacksburg', 'VA', 24060, 'Advertiser'),
...
(1, 6, 'Billy', 'Ozycz', 'Male', '20.00', 'Silver', 0, 'Balance,Core,Endurance,Flexibility,Weight Loss', 'Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday', '8AM-10PM', 'BillyOzycz.png', 'Everyday two-a-days is a normal thing for me and can be for you too!  With the right balance of lifting and cardio I can give you the nice, toned body you have always wanted.'),
(2, 3, 'JP', 'Theo', 'Male', '25.00', 'Gold', 1, 'Core,Endurance,Flexibility,Strength,Water Aerobics', 'Monday,Tuesday,Wednesday,Thursday,Friday', '8AM-10PM', 'JP.png', 'Avid athlete in all sports - currently Rugby at Virginia Tech.  With monster biceps and indestructable core there is no surprise to why the people call him "Big Sexi."'),
(3, 4, 'shawn', 'neylon', 'Male', '40.00', 'Platinum', 1, 'Balance,Core', 'Monday,Wednesday', '5AM-6PM', 'ShawnNeylon.png', 'Former Marine and US Marshal, workouts with me will push you to the limit.  I am a working man with a family so for those of you looking to book sessions on the weekend - I''m your guy.');
