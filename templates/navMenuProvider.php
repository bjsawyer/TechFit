        ...
        <nav class="navbar navbar-default navbar-fixed-top navbar-background-color">
            <div class="container-fluid custom-page-width">
			    <div class="navbar-header">
			        ...
			        <a class="navbar-brand" href="index.php">TechFit</a>
			    </div>
			    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-left" id="nav-pills-format">
				        ...
				        ?>
						        <li <?=echoActiveClassIfRequestMatches("inquiries")?>><a href="inquiries.php"><span name="Inquiries" class="glyphicon glyphicon-th-list"></span></a></li>
                    </ul>
                    <?
